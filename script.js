...
function sortMoviesByRank(movies){
  ...
  for (let j = 0; j < movies.length - 1; j++) {
      ...
      let maxRanked = movies[j];
      let maxLocation = j;

      for (let i = j; i < movies.length; i++) {
          if (movies[i].rank > maxRanked.rank) {
      ...
      movies[maxLocation] = movies[j];// --> 10
      movies[j] = maxRanked;
  }
  ...
  // CODE GOES HERE
    ...
    if(sortAttr == "title") {
        for (let j = 0; j < movies.length - 1; j++) {
            ...
            // for (let i = j; i < movies.length; i++) {
            //     if (movies[i][sortAttr] < maxRanked[sortAttr]) {
            //         // Know max AND it's index (location)
            //         maxRanked = movies[i];
            //         maxLocation = i;
            //     }
        ...
        for (let j = 0; j < movies.length - 1; j++) {
            ...
            maxRanked = max.max_obj;
            maxLocation = max.max_index;
            // for (let i = j; i < movies.length; i++) {
            //     if (movies[i][sortAttr] > maxRanked[sortAttr]) {
            //         // Know max AND it's index (location)
            //         maxRanked = movies[i];
